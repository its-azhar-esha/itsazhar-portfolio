...
import { DEFAULT_TERMS_CONTENT, type TermsPageContent } from "@/lib/content/defaults/terms";
...
export default async function TermsPage() {
  const content = await getPublicPageContent<TermsPageContent>("terms", DEFAULT_TERMS_CONTENT);
