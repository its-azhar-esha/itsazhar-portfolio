    ...
    groups: [
      {
        ...
        fields: [
          ...
          { key: "watchDemo", label: "Watch Demo button", type: "text" },
          { key: "viewCaseStudy", label: "View Case Study button", type: "text" },
          { key: "viewAll", label: "View All button", type: "text" },
        ],
      },
      {
      ...
      },
      {
        ...
        fields: [
          { key: "title", label: "Title", type: "text" },
          { key: "intro", label: "Intro", type: "textarea" },
          { key: "challenge", label: "The Challenge label", type: "text" },
          { key: "solution", label: "The Solution label", type: "text" },
          { key: "workflow", label: "Workflow label", type: "text" },
          { key: "impact", label: "Impact label", type: "text" },
          { key: "readMore", label: "Read Full Case Study button", type: "text" },
        ],
      },
      {
      ...
      },
      {
        ...
        fields: [
          ...
          { key: "intro", label: "Intro", type: "textarea" },
          { key: "moreLabel", label: "More About Me button", type: "text" },
          {
            key: "roles",
      ...
      },
      {
        ...
        fields: [
          { key: "title", label: "Title", type: "text" },
          { key: "intro", label: "Intro", type: "textarea" },
          { key: "priceBadge", label: "Price badge", type: "text" },
          { key: "auditTitle", label: "Audit card title", type: "text" },
          { key: "auditDescription", label: "Audit card description", type: "textarea" },
          { key: "bookLabel", label: "Book audit button", type: "text" },
          { key: "viewProjectsLabel", label: "View Projects button", type: "text" },
          { key: "findMeOn", label: "Find me on title", type: "text" },
          { key: "details", label: "Details title", type: "text" },
