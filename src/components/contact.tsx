          ...
          >
            ...
            >
              ...
              <CardHeader>
                ...
                <CardDescription>
                  15-minute call to discover automation opportunities in your
                  business workflow.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="flex flex-col gap-3 pt-4 sm:flex-row">
                  <motion.div whileHover={{ scale: 1.02, y: -1 }} whileTap={{ scale: 0.98 }} transition={spring}>
                    <Link href="/contact">
                      <Button size="lg" className="group gap-2 shadow-sm transition-shadow duration-200 hover:shadow-md">
