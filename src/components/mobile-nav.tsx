...
export function MobileNav() {
  ...
  return (
    ...
    >
      <div className="rounded-t-2xl border-t border-border/50 bg-background/80 pb-safe shadow-2xl shadow-primary/5 backdrop-blur-2xl">
        <div className="flex items-center justify-around px-2 pt-1">
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                <motion.div
                  animate={
                    active ? { y: -2, scale: 1.05 } : { y: 0, scale: 1 }
                  }
          ...
          >
            <motion.div
              ...
              className="flex items-center justify-center rounded-lg bg-gradient-to-br from-primary/15 to-primary/5 p-1.5 text-primary shadow-[0_0_12px_-4px_hsl(var(--primary)/0.3)]"
            >
